...
| `group_ids`                         | `object`       | when canonical grouping ids are available         | `stable`  | `dagzoo.io.shard_contract.build_dataset_catalog_record` | `keep`                                                  | stable downstream grouping keys                            |
| `group_ids.layout_plan`             | `string`       | when group_ids present                            | `stable`  | `dagzoo.io.shard_contract.build_dataset_catalog_record` | `keep`                                                  | shared layout-plan grouping key                            |
...
| `n_classes`                         | \`int          | null\`                                            | always    | `stable`                                                | `dagzoo.io.shard_contract.build_dataset_catalog_record` | `keep`                                                     |
