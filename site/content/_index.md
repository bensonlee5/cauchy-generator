...
Install dagzoo, inspect the recipe catalog, generate a first run, publish a handoff root, and use the same recipe in Python.
{{% /blocks/feature %}}
...
{{% blocks/feature icon="fas fa-cloud-upload-alt" title="Publish to Hub" url="docs/publish-hub/" %}}
Generate a portable handoff root, keep dagzoo-only sidecars local, and publish the public corpus to Hugging Face Hub.
{{% /blocks/feature %}}
